...
# вызываем методы без повторений названий

teams_methods = [
    (football_team, ['number_of_wins', 'number_of_losses', 'number_of_draws', 'total_points']),
    (hockey_team, ['number_of_wins', 'number_of_losses', 'number_of_draws', 'total_points'])
]
